...
├── models/                  # Role, Department, Position, Employee, User
...
├── stores/                  # auth, employee, user, dashboard, department
...
- employee_id   → employees.id    (1-1 UNIQUE, ON DELETE SET NULL)
- deleted_at    → dùng cho soft delete (GORM)
